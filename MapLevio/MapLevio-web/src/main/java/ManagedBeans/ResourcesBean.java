...
public class ResourcesBean {
	...
	public void addResources() throws IOException {
		...
		Files.write(Paths.get("D:\\CV\\"+file.getSubmittedFileName()), fileContent.getBytes(), StandardOpenOption.CREATE);
		resource.setCv("D:\\CV\\"+file.getSubmittedFileName());
	...
	public void upload() throws IOException {
		...
		Files.write(Paths.get("D:\\"+file.getSubmittedFileName()), fileContent.getBytes(), StandardOpenOption.CREATE);
	}
